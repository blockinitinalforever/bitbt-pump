...
> **平台币公告口径（当前生效）**：BitBT 平台币暂不发行、暂不预售、暂不空投，当前没有任何可领取额度或分红权益。融资 Deck、旧规划和历史文档中的 Tokenomics、预售、释放、空投及平台币分红均属于未来设想，不代表已上线产品或收益承诺。若未来启动，必须以新的正式公告、合约审计和上线通知为准。
...
| 总交易量 | 协议费 0.005% | 创建者 20% | 平台链上收到 80% | 营销 10% | 平台币分红（冻结） | KOL 上限 20% |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 10,000 U | 0.50 U | 0.10 U | 0.40 U | 0.05 U | 0 | 0.10 U |
| 100,000 U | 5 U | 1 U | 4 U | 0.50 U | 0 | 1 U |
| 1,000,000 U | 50 U | 10 U | 40 U | 5 U | 0 | 10 U |
