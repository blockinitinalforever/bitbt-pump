...
(() => {
  ...
  setLaunchAvailability(false); invalidateLaunchSnapshot(); clearPrototype(); bindProviderEvents(); bindNavigation(); bind(); void load(); window.setInterval(() => { if (document.visibilityState !== "hidden") void refreshLive(); }, 15000);
})();
